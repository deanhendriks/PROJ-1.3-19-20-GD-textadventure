...
descriptions = [];
descriptions[0] = ["Je bevind jezelf in de kantine. Hier zitten studenten te eten of op hun laptop.", "", "",""];
descriptions[1] = ["u staat op een trap naar de eerste etage. Er lopen veel studenten om je heen.", "", "",""];
descriptions[2] = ["Je hebt gewonnen!", "", "","shag"];
descriptions[3] = ["u staat in de lerarenkamer. De leraren eten hier hun lunch en chillen hier.", "Shag", "shag.png",""];
descriptions[4] = ["u staat in de Gang. Studenten en leraren lopen rondom je heen", "", "",""];
descriptions[5] = ["u staat in het medialab. ", "Steen", "rock.png",""];
descriptions[6] = ["u staat bij de toiletten", "", "",""];
descriptions[7] = ["u staat in een klaslokaal. ", "kaas", "kaas.png",""];
  ...
  if (evt.key == "Enter") {
    ...
    if (inputArray[0] == "ga") {
      if (directions[currentLocation].indexOf(inputArray[1]) != -1) {
        ...
        feedback.innerHTML = "ERROR ga...noord,west,zuid,oost";
